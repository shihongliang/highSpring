...
<body>
	...
	<form name="Form1" method="post" action="name.aspx" id="Form1">
		...
		<table width="100%" border="0" height="88" border="1"
			...
			<tr>
				<td width="50%" height="88" align="left" valign="top" id="stationtd">
					...
					<fieldset id="stationset"
						...
						<IFRAME
							src="${pageContext.request.contextPath }/admin/alermStation"
				...
				<td width="50%" align="left" valign="top" id="devtd">
					<fieldset id="devset"
						...
						<IFRAME
							src="${pageContext.request.contextPath }/admin/alermDevice"
