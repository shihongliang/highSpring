...
<script language="javascript">
	...
	{   
		...
		
		{
			...
			document.all.image.src="${pageContext.request.contextPath }/resources/images/you.gif";
		}
		else if(parent.document.getElementById("main").cols=="0,1%,99%")
		{
			parent.document.getElementById("main").cols='153,1%,*';
				
			document.all.image.src="${pageContext.request.contextPath }/resources/images/zuo.gif";
		}
...
<table width=1 style="cursor: hand" height="100%" background="" cellspacing="0" cellpadding="0" >
    ...
    <p align="center">
 		<img id="image" src="${pageContext.request.contextPath }/resources/images/zuo.gif" width="9" height="79" >       
    </p>
