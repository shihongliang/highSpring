...
public class TestDeviceInfo extends AbstractDbUnitTestCase {
	@Inject
	...
	@Test
	public void testDataChart()
	{
		List<DeviceInfo> eclist=deviceInfoDao.generateChart();
		System.out.println(eclist);
		
	}
	@Test
	public void testNewLineChart()
	{
		TLine eclist=deviceInfoDao.generateNewChart();
		System.out.println(eclist);
